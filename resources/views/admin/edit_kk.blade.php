                        ...
                        <form action="{{route('update.kk')}}" id="formPenduduk" class="needs-validation" novalidate>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="hidden" class="form-control" name="id_kk" id="id_kk" value="{{$data->no_kk}}">
        ...
        $.ajax({
            ...
            error: function (response) {
                ...
                if (errors) {
                    ...
                    if(errors.kepala_keluarga) {
                        // console.log(errors.kepala_keluarga[0]);
                        $('#error-kepala_keluarga').text(errors.kepala_keluarga[0])
                        $('#kepala_keluarga').addClass('is-invalid');
                        swal('Kesalahan', errors.kepala_keluarga[0],'error')
                    }
                    if(errors.no_kk) {
